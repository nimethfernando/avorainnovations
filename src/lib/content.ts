...
export const TESTIMONIALS_DATA = [
  {
    id: '1',
    quote: 'Avora Innovations completely reimagined our digital infrastructure. Their ability to bridge complex deep learning research with production-grade reliability is unlike any technology partner we have worked with.',
    author: 'Dr. Elena Rostova',
    role: 'VP of Clinical Informatics',
    company: 'HealthTech Systems',
    rating: 5,
    avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=200&q=80',
    project: 'Clinical Vision & Diagnostics Pipeline',
    metric: '82% Triage Backlog Cut',
    tags: ['AI Diagnostics', 'DICOM WebGL', 'Edge Inference'],
    fullReview: 'We partnered with Avora to solve an urgent clinical challenge: emergency radiologists across our hospital network were overwhelmed by scanning volume. Avora’s team engineered an edge-integrated computer vision pipeline that ingests DICOM scans, runs vision transformers for anomaly pre-screening, and delivers sub-minute triage alerts directly into physician workflows. Their team maintained strict non-disclosure, adhered to air-gapped security protocols, and gave us 100% ownership of model weights and architecture.',
  },
  {
    id: '2',
    quote: 'The AI fraud prevention engine Avora engineered for our neo-banking platform stopped 84% of chargebacks in month one. They are fast, meticulous, and deeply technical.',
    author: 'Marcus Vance',
    role: 'Chief Technology Officer',
    company: 'Apex Global Financial',
    rating: 5,
    avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=200&q=80',
    project: 'Real-Time Fraud Prevention Engine',
    metric: 'Sub-15ms Detection Latency',
    tags: ['FinTech', 'High Concurrency', 'Go & MariaDB'],
    fullReview: 'When looking to rebuild our core transaction authorization infrastructure, traditional consultancies proposed 12-month discovery phases with large teams of junior developers. Avora operated completely differently: two senior distributed systems architects and an ML specialist deployed a prototype within 3 weeks. The final Go and MariaDB microservices handled our peak Black Friday transaction surge without a millisecond of jitter, cutting fraud losses by 84% in the first 30 days.',
  },
  {
    id: '3',
    quote: 'Our Black Friday traffic surged 300%, and our Next.js storefront did not flinch once. Page loads stayed under 700ms across every geography. Avora has earned our highest recommendation.',
    author: 'Jean-Luc Mercier',
    role: 'VP of Digital Commerce',
    company: 'Velour Omnichannel Retail',
    rating: 5,
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=200&q=80',
    project: 'Omnichannel Headless E-Commerce',
    metric: '680ms Global LCP Under Load',
    tags: ['Next.js 16', 'React 19', 'Turbopack', 'Edge Caching'],
    fullReview: 'Our legacy monolithic e-commerce stack suffered severe performance degradation during seasonal flash events. Avora systematically migrated our frontend to Next.js 16 App Router with React 19 server components and edge streaming. The architecture delivers exceptional Core Web Vitals (100/100 Lighthouse) globally, resulting in a 28% increase in mobile checkout conversions and zero downtime across 14 international storefronts.',
  },
  {
    id: '4',
    ...
    company: 'TransGlobal Fleet Logistics',
    rating: 5,
    avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=200&q=80',
    project: 'Edge IoT Fleet Telematics Gateway',
    metric: '$14M+ First-Year Fleet Savings',
    tags: ['IoT Sensors', 'MQTT Gateway', 'Rust Firmware'],
    fullReview: 'Managing cold-chain pharmaceutical cargo across international transit required millisecond-accurate sensor telemetry. Avora designed both the embedded microcontroller firmware and the high-throughput cloud ingestion backend. Their team resolved difficult real-time race conditions that two previous vendors failed to solve, delivering tamper-evident audit trails and saving our enterprise more than $14M in fuel and logistics loss prevention.',
  },
  {
    id: '5',
    quote: 'Avora built our underwriting and portfolio analytics platform from the ground up in just ten weeks. The code quality, automated test coverage, and documentation exceeded our highest expectations.',
    author: 'David Zhao',
    role: 'Managing Director of Technology',
    company: 'PropTech Capital Partners',
    rating: 5,
    avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=200&q=80',
    project: 'Commercial Asset Underwriting Portal',
    metric: '10-Week Zero-Debt Delivery',
    tags: ['PropTech', 'Cloud Architecture', 'TypeScript'],
    fullReview: 'In commercial real estate private equity, speed to market and financial modeling accuracy are paramount. Avora’s senior engineers grasped our quantitative models immediately and turned complex multi-variable valuation formulas into an intuitive, responsive web application. The delivery was on-time, within the exact fixed-scope budget, and backed by a complete test suite and comprehensive architecture documentation.',
  },
];
