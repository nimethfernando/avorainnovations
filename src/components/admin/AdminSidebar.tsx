...
export default function AdminSidebar() {
  ...
  const nav = [
    ...
    { label: 'Services & Sub-Services', href: '/admin/services', icon: Cpu },
    { label: 'Industry Verticals', href: '/admin/industries', icon: Building },
    { label: 'Technology Stacks', href: '/admin/technologies', icon: Terminal },
    { label: 'Case Studies', href: '/admin/case-studies', icon: CheckCircle },
    { label: 'Client Testimonials', href: '/admin/testimonials', icon: Star },
